      ...
      <div className="container relative z-10 mx-auto px-6 py-20 lg:py-32">
        <div className="max-w-3xl">
          <motion.div
            ...
            className="mb-6"
          >
            <span className="inline-block px-4 py-1.5 rounded-full border border-gold/30 bg-gold/10 text-gold-light text-sm font-body tracking-wide">
          ...
          <motion.p
            ...
            className="font-body text-lg md:text-xl text-primary-foreground/80 leading-relaxed mb-4 max-w-2xl"
          >
          ...
          <motion.p
            ...
            className="font-body text-base text-primary-foreground/60 leading-relaxed mb-10 max-w-2xl"
          >
          ...
          >
            <a
              ...
              className="inline-flex items-center justify-center gap-3 px-8 py-4 rounded-lg bg-accent text-accent-foreground font-body font-semibold text-base shadow-gold transition-all hover:scale-[1.02] hover:brightness-110"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center gap-3 px-8 py-4 rounded-lg border border-primary-foreground/20 text-primary-foreground font-body font-medium text-base transition-all hover:bg-primary-foreground/10"
            >
